...
export default function Header() {
  return (
    <div className="w-full h-[110px] flex justify-between p-[30px]">
      <div className="flex gap-0 w-[495px] justify-between">
        <div className="flex ">
          <div className="relative flex flex-col px-2 gap-1">
            ...
            <div className="absolute top-0 bottom-[-25px] right-[-45px] border-l-[1px] border-black"></div>
          </div>
        </div>
